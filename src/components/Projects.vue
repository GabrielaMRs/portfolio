    ...
    <div class="cards">
      <div class="card-project">
        ...
        <p class="project-description">
          This was a challenge made by FrontEndMentor. The objective was to integrate the advice api and at each click, generate a new advice.
        </p>
        ...
        <div class="projects-links">
          ...
          <a target="_blank" href="https://github.com/GabrielaMRs/advice-generator-app-main" alt="Link para o código do projeto.">
            <svg
              width="20px"
              height="20px"
              viewBox="0 0 20 20"
      ...
      <div class="card-project">
        ...
        <div class="projects-links">
          ...
          <a target="_blank" href="https://github.com/GabrielaMRs/snap-page" alt="Link para o código do projeto.">
            <svg
              width="20px"
              height="20px"
              viewBox="0 0 20 20"
